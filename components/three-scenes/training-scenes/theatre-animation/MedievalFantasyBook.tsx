...
export function MedievalFantasyBook({ envMapIntensity = 0.3, ...props }) {
  ...
  const { nodes, materials, animations } = useGLTF(
    "/3d-models/theatre-animation/medieval_fantasy_book.glb"
  );
  ...
  }, [actions, envMapIntensity, materials]);
  return (
...
useGLTF.preload("/3d-models/theatre-animation/medieval_fantasy_book.glb");
